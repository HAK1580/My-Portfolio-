...
const Hero = () => {
  ...
  return (
    <div>
        <div className="hero my-12 lg:w-[90%]  max-[500px]:max-w-[98%] sm:max-w-[92%] max-w-[95%]  mx-auto  flex justify-between  ">
            <div className="name-des font-medium   flex flex-col gap-1">
                ...
                <a className=' flex justify-center lg:py-2 lg:rounded-[8px] hover:bg-blue-700 hover:text-[#ffffff9f]  lg:text-[1.6rem] lg:w-55 items-center rounded-[5px] px-1 w-30 py-1.5 bg-blue-600 ' href="assets/Cv.pdf" download={"assets/Cv.pdf"}  > Download CV </a>
                 </div>
